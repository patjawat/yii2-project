...
echo Nav::widget([
    ...
    'items' => [
        ['label' => '<i class="fa-solid fa-house-user"></i> หน้าหลัก', 'url' => ['/booking']],
        ['label' => '<i class="fa-solid fa-user-tag"></i> หนักงานคนขับ', 'url' => ['/booking/default/driver-list']],
        ['label' => '<i class="fa-solid fa-info"></i> เกี่ยวกับระบบ', 'url' => ['/site/contact']],
        ['label' => '<i class="fa-solid fa-user-tag"></i> ภาระกิจ'.(BookingHelper::Myjob() > 0 ? ' <span class="badge bg-danger">'.BookingHelper::Myjob().'</span>' : null), 'url' => ['/booking/vehicle/myjob']],
        ['label' => '<i class="fa-solid fa-list-ul"></i> รายการขอใช้ยานพหนะ', 'url' => ['/booking/vehicle/order']],
        [
            'label' => 'ตั้งค่า', 
            'items' => [
