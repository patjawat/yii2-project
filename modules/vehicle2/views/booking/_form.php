            ...
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
                <div class="card border-0 border-radius-lg">
                    <div class="card-body">
                        ...
                        <div class="alert alert-success" role="alert">ข้อมูลการเดินทาง</div>
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-8">
                                    <?=$form->field($model, 'title', [
                                        ...
                                        'inputOptions' =>['autofocus' => 'autofocus','tabindex' => '1']])->textInput(['disabled' => $disable])->label('วัตถุประสงค์การจอง')?>
                        ...
                        <div class="alert alert-success" role="alert">รายละเอียดการขอใช้</div>
                        <div class="row">
                            <div class="col-6">
